...
function setCells() {
    for(let i = 0; i < cellsInRow; i++)for(let j = 0; j < cellsInRow; j++){
...
function gameIsLost() {
    ...
    for(let i = 0; i < cellsInRow - 1; i++)for(let j = 0; j < cellsInRow; j++){
        if (field[i][j] === field[i + 1][j]) return false;
    }
    return true;
}
function slide(row) {
...
function slideUp() {
    for(let i = 0; i < cellsInRow; i++){
        ...
        col = slide(col);
        for(let j = 0; j < cellsInRow; j++)field[j][i] = col[j];
    }
}
function slideDown() {
    for(let i = 0; i < cellsInRow; i++){
